...
Use this tool before using MapMerge2 or opening the map in an map editor. This is because the map editor may discard any unknown paths not found in the byond environment (or what it builds after parsing `auristation.dme`).
