...
/obj/item/clothing/under/rank/medical/paramedic/skirt
	...
	desc = "It has a dark blue cross on the chest denoting that the wearer is a trained paramedic."
