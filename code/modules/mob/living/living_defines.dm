/mob/living
	...
	/// Represents the exhaustion of a mob, as a body-wide injury
	var/exhaustion = 0

	/// Injuries sustained by this mob, key'd by the typepath of the base injury
	VAR_PROTECTED/list/injuries = list()
