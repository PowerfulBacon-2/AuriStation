...
/obj/machinery/atmospherics/components/unary/vent_pump/add_context_self(datum/screentip_context/context, mob/user)
	. = ..()
	context.add_left_click_tool_action("Repair", TOOL_SCREWDRIVER)
