...
/datum/symptom/flesh_eating/proc/Flesheat(mob/living/M, datum/disease/advance/A)
	if(damage)
		M.take_direct_overall_damage(BURN, rand(15,25), required_status = BODYTYPE_ORGANIC)
	if(!ishuman(M))
		return
...
/datum/symptom/flesh_death/proc/Flesh_death(mob/living/M, datum/disease/advance/A)
	...
	M.take_direct_overall_damage(BRUTE, get_damage, required_status = BODYTYPE_ORGANIC)
	if(chems)
