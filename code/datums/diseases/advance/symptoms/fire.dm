...
/datum/symptom/fire/proc/Firestacks_stage_4(mob/living/M, datum/disease/advance/A)
	...
	M.take_direct_overall_damage(BURN, 3 * power, required_status = BODYTYPE_ORGANIC)
...
/datum/symptom/fire/proc/Firestacks_stage_5(mob/living/M, datum/disease/advance/A)
	...
	M.take_direct_overall_damage(BURN, 5 * power, required_status = BODYTYPE_ORGANIC)
	if(infective && !(A.spread_flags & DISEASE_SPREAD_FALTERED))
...
/datum/symptom/alkali/proc/Alkali_fire_stage_4(mob/living/M, datum/disease/advance/A)
	...
	M.take_direct_overall_damage(BURN, get_stacks / 2, required_status = BODYTYPE_ORGANIC)
...
/datum/symptom/alkali/proc/Alkali_fire_stage_5(mob/living/M, datum/disease/advance/A)
	...
	M.adjust_fire_stacks(get_stacks)
	M.take_direct_overall_damage(BURN, get_stacks, required_status = BODYTYPE_ORGANIC)
	if(chems && M.stat != DEAD)
