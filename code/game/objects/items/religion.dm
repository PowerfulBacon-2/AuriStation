...
/obj/item/banner/proc/inspiration(mob/living/carbon/human/H)
	...
	H.take_consciousness_damage(-40)
...
/obj/item/banner/medical
	...
	lefthand_file = 'icons/mob/inhands/equipment/banners_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/banners_righthand.dmi'
	job_loyalties = list(JOB_NAME_SURGEON, JOB_NAME_MEDICALDOCTOR, JOB_NAME_CHEMIST, JOB_NAME_GENETICIST, JOB_NAME_PARAMEDIC, JOB_NAME_CHIEFMEDICALOFFICER)
