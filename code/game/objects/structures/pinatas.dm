...
/obj/structure/pinata
	...
	var/debris = /obj/effect/decal/cleanable/pinata
...
/obj/structure/pinata/take_direct_damage(amount, type, flag, zone)
	. = ..()
...
/obj/structure/pinata/syndie
	...
	destruction_loot = 2
	debris = /obj/effect/decal/cleanable/pinata/syndie
	candy_options = list(
		/obj/item/food/rock_candy,
		/obj/item/food/candy,
		/obj/item/food/chocolatebar,
...
/obj/structure/pinata/donk
	...
	debris = /obj/effect/decal/cleanable/pinata/donk
	candy_options = list(
